...
namespace Unidade_Lógica_e_Aritmética
{
    class UnidadeLogica24bits
    {
        ...
        public bool ULA24Bits(bool[] a, bool[] b, bool[] f, bool[] s)
        {
            ...
            s[23] = ALU23.ULA1Bit(a[23], b[23], f, vem1, out vai1);
            vem1 = vai1;
            s[22] = ALU22.ULA1Bit(a[22], b[22], f, vem1, out vai1);
            vem1 = vai1;
            s[21] = ALU21.ULA1Bit(a[21], b[21], f, vem1, out vai1);
            vem1 = vai1;
            s[20] = ALU20.ULA1Bit(a[20], b[20], f, vem1, out vai1);
            vem1 = vai1;
            s[19] = ALU19.ULA1Bit(a[19], b[19], f, vem1, out vai1);
            vem1 = vai1;
            s[18] = ALU18.ULA1Bit(a[18], b[18], f, vem1, out vai1);
            vem1 = vai1;
            s[17] = ALU17.ULA1Bit(a[17], b[17], f, vem1, out vai1);
            vem1 = vai1;
            s[16] = ALU16.ULA1Bit(a[16], b[16], f, vem1, out vai1);
            vem1 = vai1;
            s[15] = ALU15.ULA1Bit(a[15], b[15], f, vem1, out vai1);
            vem1 = vai1;
            s[14] = ALU14.ULA1Bit(a[14], b[14], f, vem1, out vai1);
            vem1 = vai1;
            s[13] = ALU13.ULA1Bit(a[13], b[13], f, vem1, out vai1);
            vem1 = vai1;
            s[12] = ALU12.ULA1Bit(a[12], b[12], f, vem1, out vai1);
            vem1 = vai1;
            s[11] = ALU11.ULA1Bit(a[11], b[11], f, vem1, out vai1);
            vem1 = vai1;
            s[10] = ALU10.ULA1Bit(a[10], b[10], f, vem1, out vai1);
            vem1 = vai1;
            s[9] = ALU9.ULA1Bit(a[9], b[9], f, vem1, out vai1);
            vem1 = vai1;
            s[8] = ALU8.ULA1Bit(a[8], b[8], f, vem1, out vai1);
            vem1 = vai1;
